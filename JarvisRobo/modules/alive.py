...
# Video URL
VIDEO_URL = "https://telegra.ph/file/f5742374e63d45ffdd1bc.mp4"

# Inline keyboard markup
Jarvis = [
    [
        InlineKeyboardButton(text="ᴊᴀʀᴠɪs", user_id=OWNER_ID),
        InlineKeyboardButton(text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/BROKENXNETWORK"),
    ],
    [
...
async def send_alive_message(client, message: Message):
    ...
    await accha.edit("ʙʀᴏᴋᴇɴ's ᴄᴀᴄʜɪɴɢ ᴅᴀᴛᴀ..")
    await asyncio.sleep(0.1)
    await accha.edit("ᴄᴏʀᴇ ᴀɴᴀʟʏsᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ...")
    await asyncio.sleep(0.1)
    await accha.edit("ʙʀᴏᴋᴇɴ 🔮 ᴀʟɪᴠɪɴɢ..")
    await accha.delete()
...
━━━━━━━━━━━━━━━━━━━
» **ᴍʏ ᴏᴡɴᴇʀ :** [ᴏᴡɴᴇʀ](https://t.me/mrbrokn)
...
━━━━━━━━━━━━━━━━━━━""",
        reply_markup=InlineKeyboardMarkup(ʙʀᴏᴋᴇɴ),
    )
